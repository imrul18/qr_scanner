            ...
            <div class="col-md-4 col-12">
                <div class="auth-wrapper auth-basic px-2">
                    <div class="auth-inner my-2">
                        <div class="card-body"
                            style="background-image: url('{{ asset('storage/event/' . $ticket->event->bg_image) }}'); z-index: 1000;">
                            <div class="p-1"
                                style="font-family: {{ $ticket->event->font_family }}; color: {{ $ticket->event->font_color }}">

                                <div class="text-center my-1">
                                    <img src="{{ asset('storage/event/' . $ticket->event->logo) }}" alt="logo"
                                ...
                                <div class="d-flex justify-content-between mt-1">
                                    <img src="{{ asset('storage/event/' . $ticket->event->partner_logo) }}"
                                        alt="Partner Logo" class="rounded" height="40">
                                    <span>
                                        <img src="{{ asset('storage/event/' . $ticket->event->aminity_logo) }}"
